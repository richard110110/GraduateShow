...
function changeValue(){
    var value = document.getElementById('chooseDegree').options[document.getElementById('chooseDegree').selectedIndex].text;
    console.log(value);
...
.then(function (data) {
//     var returnedSelected = changeValue();
//   console.log("this is returnedSelected: " + returnedSelected);
  console.log(data);
  ...
  for(var i=0; i<data.length;i++){
    ...
    // options +=`<option value=${data[i].degree}>${data[i].degree}</option>`
  }
...
//   const finalOption = Array.from(optionSet);
...
// changeValue(data);
  ...
  document.getElementById('chooseDegree').innerHTML = options;
  ...
  if(document.getElementById('chooseDegree').options[document.getElementById('chooseDegree').selectedIndex].text == `${data[i].degree}`){
    console.log("get");
  ...
  document.getElementById("sendValue").addEventListener("click", function(){
    ...
    for(var i=0; i< data.length;i++){
        ...
        var selectedValue = document.getElementById('chooseDegree').options[document.getElementById('chooseDegree').selectedIndex].text;

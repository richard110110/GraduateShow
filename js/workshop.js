...
/*for workshop.html functional list the artist by the workshop keyword*/
...
fetch(artist_url)
    ...
    .then(function(data) {
        ...
        /*using the set no duplicates property to remove all the duplicates workshop and send them to the options tag as the value*/
        ...
        document
            .getElementById('chooseWorkshop')
            .innerHTML = options;
        /*when this page is loaded, loaded the each-artist card referred from the first displayed value in the option tag in workshop select box*/
        for (var i = 0; i < data.length; i++) {
            ...
            /*list each artist information that referred from the workshop value*/
            if (document.getElementById('chooseWorkshop').options[
                    document
                    .getElementById('chooseWorkshop')
                    .selectedIndex

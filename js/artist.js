...
.then(function (data) {
  ...
  for(i=0; i<data.length;i++){
    ...
    `<div style=" border: 10px solid transparent; border-image: url(../images/artist-images/frame.jpg) 30 round; width:300px;height: 200px; background-image: url(../images/thumbnails/${validateImage(data[i].Thumbnail).split(' ').join('%20')}); background-size: auto 100%; background-position: center center; background-repeat: no-repeat; margin: 0"></div>`+
